...
const checkCollectionGeoJSON = data => CollectionTypes.indexOf(data.type) !== -1;
...
const getCoordinateForPosition = (position, geoJSONType = GeoJSONTypes.FeatureCollection) => {
