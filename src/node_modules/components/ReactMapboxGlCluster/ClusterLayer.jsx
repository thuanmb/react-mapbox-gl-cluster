...
class ClusterLayer extends PureComponent {
  ...
  _getPointsProps(points) {
    return points.map(point => point.props["data-feature"].properties);
  }
...
ClusterLayer.propTypes = {
  ...
  /**
   * [Optional] Handle when user move the mouse enter a point/cluster
   */
  onMouseEnter: PropTypes.func,

  /**
   * [Optional] Handle when user move the mouse leave a point/cluster
   */
