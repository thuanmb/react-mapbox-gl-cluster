...
import { checkPropsChange } from "nio-lib";
import NioSpiderifierPoint from "../components/NioSpiderifierPoint";
import {
...
const connectWithSpiderifierPoint = WrappedComponent => {
  class ConnectedWithSpiderifierComponent extends Component {
    ...
    _getSpiderifierComponentProps() {
      return this._getComponentProps(NioSpiderifierPoint.propTypes);
    }
      ...
      if (group.length > 0) {
        const overlappedPointsGroup = group.map(points => {
          if (points.length > 0) {
            ...
            if (coords == null) {
              coords = getCoordinateForPosition(points[0]);
            }
            return {
  ...
  ConnectedWithSpiderifierComponent.defaultProps = {
    ...
    ...NioSpiderifierPoint.defaultProps
  };
