  ...
  function MarkerLayer() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          MarkerLayer.__proto__ ||
          Object.getPrototypeOf(MarkerLayer)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
  ...
  _createClass(MarkerLayer, [
    {
      ...
      value: function componentDidMount() {
        ...
        this.layer = new _mapboxGl2.default.Marker(node)
    ...
    },
    {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (
          ...
          (0, _utils.checkPropsChange)(this.props, nextProps, [
            "style",
            "className"
          ])
        ) {
      ...
      value: function _bindEvents() {
        ...
        _lodash2.default.forEach(events, function(handler, name) {
          ...
          _this3.element.addEventListener(
            (0, _utils.getExactEventHandlerName)(name),
            realHandler
          );
    ...
    },
    {
      ...
      value: function _unbindEvents() {
        ...
        _lodash2.default.forEach(events, function(handler, name) {
          ...
          _this4.element.removeEventListener(
            (0, _utils.getExactEventHandlerName)(name),
            realHandler
          );
        });
...
MarkerLayer.propTypes = {
   ...
   */
  properties: _propTypes2.default.oneOfType([
